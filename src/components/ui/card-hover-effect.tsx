  ...
  return (
    ...
    >
      {items.map((item, idx) => {
        ...
        return (
          <FadeOnScroll key={idx} delay={idx * 0.1}>
            <div
            ...
            >
              ...
              <div className="rounded-md w-full p-4 overflow-hidden bg-background hover:ring-2 ring-green-500 relative z-20 transition-all duration-500">
